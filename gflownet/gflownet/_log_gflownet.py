...
class GFlowNetAgent:
    ...
    def sample_batch(
            ...
            log_memory_usage("After batch initialization")
            ...
            log_memory_usage("After forward batch initialization")
            while envs:
                # Sample actions
                t0_a_envs = time.time()
            ...
            log_memory_usage("After forward trajectories")
            ...
            log_memory_usage("After train batch initialization")
            ...
            log_memory_usage("After train trajectories")
            ...
            log_memory_usage("After replay batch initialization")
